    ...
    @Select({
        "<script>",
            "SELECT ",
                ...
                "p.logo productLogo,",
                "p.base_salary basePrice,",
                "p.platform_award platformPrice,",
                "apply.mobile mobile,",
                "apply.apply_id_code orderNo,",
                "apply.name applyName,",
                "apply.status status,",
                "apply.official_status officialStatus,",
                "apply.user_id applyUserId,",
                "u.id inviteUserId,",
                "u.username inviteUserName,",
                "C.get_link getLink,",
                ...
                "AEXT.express_name expressName,",
                "AEXT.express_no expressNo,",
                "AEXT.deposit_status depositStatus,",
                "AEXT.deliver_status deliverStatus,",
                "apply.create_time applyTime,",
            ...
            "LEFT JOIN pos_apply_ext AEXT ON AEXT.apply_id = apply.id",
            "LEFT JOIN category C ON C.id = PCR.category_id",
            "LEFT JOIN user U ON U.invite_code = apply.invite_code",
