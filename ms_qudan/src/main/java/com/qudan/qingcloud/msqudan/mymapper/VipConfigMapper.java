...
public interface VipConfigMapper {
    ...
    @Insert({
        "insert into vip_config (\" id\", add_rate, ",
        "vip_price, start_time, ",
        "service_days, over_time, ",
        "vip_logo, create_time, ",
        "modify_time, isenable, ",
        "version, vip_name)",
        "values (#{id,jdbcType=INTEGER}, #{addRate,jdbcType=DECIMAL}, ",
        "#{vipPrice,jdbcType=DECIMAL}, #{startTime,jdbcType=TIMESTAMP}, ",
        "#{serviceDays,jdbcType=INTEGER}, #{overTime,jdbcType=TIMESTAMP}, ",
        "#{vipLogo,jdbcType=VARCHAR}, #{createTime,jdbcType=TIMESTAMP}, ",
        "#{modifyTime,jdbcType=TIMESTAMP}, #{isenable,jdbcType=INTEGER}, ",
        "#{version,jdbcType=INTEGER}, #{vipName,jdbcType=VARCHAR})"
    })
    ...
    @Select({
        "select",
        "\" id\", add_rate, vip_price, start_time, service_days, over_time, vip_logo, ",
        "create_time, modify_time, isenable, version, vip_name",
        "from vip_config",
        "where \" id\" = #{id,jdbcType=INTEGER}"
    })
    @Results({
