...
public interface ProductMapper {
    ...
    @Select({
        "select",
        "id, product_name, logo, product_type, is_hot, is_show, customer, \"is_ in_shop\", ",
    ...
    @Results({
        ...
        @Result(column="is_ in_shop", property="isInShop", jdbcType=JdbcType.INTEGER),
    ...
    @Update({
        ...
        "set product_name = #{productName,jdbcType=VARCHAR},",
          ...
          "\"is_ in_shop\" = #{isInShop,jdbcType=INTEGER},",
