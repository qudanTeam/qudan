package com.qudan.qingcloud.msqudan.entity.web;
...
public class ProductCategory extends PageUtils{
    //product
    private Integer id;
    ...
    public void setProgressQueryImg(String progressQueryImg) {
        this.progressQueryImg = progressQueryImg;
    }
    ...
    public void setMonthSalaryDesc(String monthSalaryDesc) {
        this.monthSalaryDesc = monthSalaryDesc;
    }
    ...
    public void setThirdSummary(String thirdSummary) {
        this.thirdSummary = thirdSummary;
    }
    ...
    public void setDetailHeaderImg(String detailHeaderImg) {
        this.detailHeaderImg = detailHeaderImg;
    }
    ...
    public void setCardProgressImg(String cardProgressImg) {
        this.cardProgressImg = cardProgressImg;
    }
